  ...
  methods: {
    ...
    normalize: function normalize(parentNode, nodes, prevNodeMap) {
      ...
      var normalizedOptions = nodes.map(function (node) {
        ...
        var isLeaf = !isBranch;
        var canSelectChildrenEvenIfDisabled = node.canSelectChildrenEvenIfDisabled;
        ...
        _this16.$set(normalized, 'canSelectChildrenEvenIfDisabled', canSelectChildrenEvenIfDisabled);
    ...
    _selectNode: function _selectNode(node) {
      ...
      if (isFullyChecked) {
        ...
        while ((curr = curr.parentNode) !== NO_PARENT_NODE) {
          if (curr.children.every(this.isSelected) && !curr.canSelectChildrenEvenIfDisabled) this.addValue(curr);else break;
        }
      }
    },
